...
void DriveToNeutral::execute(const WorldState& ws, MotionController* motion) {
...
Vector2 DriveToNeutral::getMoveToCenterVec(const WorldState& ws) const {

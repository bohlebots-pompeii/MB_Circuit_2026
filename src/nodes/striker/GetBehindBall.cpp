...
namespace GetBehindBall {
  Vector2 getBallPursuitVec(const WorldState& ws);
  Vector2 getBallApproachVec(const WorldState& ws, const int speed);
  Vector2 getBallAlignedVec(const WorldState& ws, const int speed);
